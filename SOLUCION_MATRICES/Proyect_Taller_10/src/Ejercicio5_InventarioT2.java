 ...
 */
public class Ejercicio5_InventarioT2 {
                ...
                if (index != -1) {
                    ...
                    if (cantidad <= stock) {
                        ...
                        if (total > 100) {
                            ...
                            System.out.println("¡Se aplico un descuento del 10% por superar los $100!");
                        }
...
Ingrese el codigo del producto: 001
Producto: Producto1
Ingrese la cantidad deseada: 50
Se aplico un descuento del 10% por superar los $100!
